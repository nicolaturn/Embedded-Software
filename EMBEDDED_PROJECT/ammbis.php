...
if (array_key_exists("leggi", $_POST)) {
...
?>
    ...
    if (array_key_exists("associa", $_POST)) {
        associa();
    } else if (array_key_exists("dissocia", $_POST)) {
        dissocia();
    }
    function associa()
    {
                    ...
                    <div class="row g-3">
                        ...
                        <form method="post" onchange="">
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control" id="tessnr" name="tessnr" placeholder="Numero tessera" value="<?php echo $_POST["tessnr"] ?>">
                                <!-- poi aggiungere disabled-->
                            </div>
                            (dopo aver scritto il numero premere invio)
                            <hr class="my-4">
                            <?php
